...
pub fn feed_from_posts(posts: List(post.Post)) -> Element(msg) {
  ...
  element("rss", [attribute.attribute("version", "2.0")], [
    element("channel", [], [
      element("title", [], [text("heesungjang.com posts feed")]),
      link("https://heesungjang.com"),
      element("description", [], [
...
fn to_feed_item(post: post.Post) -> Element(msg) {
  element("item", [], [
    ...
    link("https://heesungjang.com/posts/" <> post.meta.id <> ".html"),
    element("description", [], [text(post.meta.abstract)]),
    element("author", [], [text("heesungj7@gmail.com")]),
